...
class ShotgunAmmo(GroundItem):
    def __init__(self,
                 ...
                 quantity=10,
                 weapon_id=2):
        super().__init__(game=game, path=path, item_id=item_id, pos=pos, scale=scale, shift=shift, animation_time=animation_time, quantity=quantity, weapon_id=weapon_id)
        self.size = 5
        self.available = True
