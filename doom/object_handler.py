from doom.ground_weapon import GroundShotgun, GroundAxe
from weapon import *
from npc  import *
...
class ObjectHandler:
    def __init__(self, game):
        ...
        self.available_ground_weapons = [GroundShotgun, GroundAxe]
        self.weights = [70, 30]
        ...
        self.all_weapons = {1: PistolWeapon, 2: ShotgunWeapon, 3: AxeWeapon}
